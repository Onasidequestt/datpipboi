...
right here in the terminal.
  ...
  python3 status.py            # bot 1 (default)
  python3 status.py --bot 2    # a specific bot
  python3 status.py --all      # every bot you're running
  python3 status.py --trades 8 # show more recent trades
